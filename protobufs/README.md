# Protocol Buffers sources

Carefully _collected & copied_ `protobufs` necessary for project.

## Sources

Sourced from [SteamDatabase/Protobufs](https://github.com/SteamDatabase/Protobufs).
